![resume](https://github.com/Yakuho/ReadItEasy/blob/master/docs/resume.png)
...
以上使用的数据集测试均可在[evaluate](https://github.com/Yakuho/ReadItEasy/tree/master/evaluete)目录下找到, 欢迎复现尝试
